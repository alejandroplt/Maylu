                    ...
                    <form action="BD/inserUsuario.php" method="POST">
                        ...
                        <div class="contenedor-inputs">
                            ...
                            <select name="id_caja" class="select">
                                <option selected value="0"> Elige una opci髇 </option>
                            ...
                            <input type="text" name="direccion" placeholder="Direcci髇">
                            <input type="text" name="tel" placeholder="Telefono">
                            <input type="text" name="email" placeholder="Correo electr髇ico">
                            <input type="text" name="usuario" placeholder="Usuario">
                            <input type="text" name="contra" placeholder="Contrase馻">
                        </div>
                        <br>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#" id="btnabrir" >
                                ...
                                <span class="menu-text" onclick="cierra()">Cerrar sesi贸n</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div id="divcerrar">
                        <a href="login.html">
                            <button class="btn-tiny btn-danger">
                                Cerrar Sesi贸n <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
